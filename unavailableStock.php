...
$unavailableStocks = $stock->getUnavailableStocks();
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display table table-striped" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            <?php if ($unavailableStocks != FALSE) { 
                                                foreach($unavailableStocks as $index => $stockInfo) { 
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <a href="#" class="btn btn-primary shadow btn-xs btn_circle sharp" data-bs-toggle="modal" data-bs-target="#editStockModal<?php echo $stockId?>">
