                                        ...
                                        <tbody>
                                            ...
                                            if ($allSales != FALSE) { $i = 1;
                                                foreach ($allSales as $salesInfo) { ?>
                                                    <td><?php echo $i; ?></td>
                                                    <td>
                                                        <?php echo $salesInfo['waiter']; ?> <br/>
                                                        <strong style="color: red">Reference: </strong> <?php echo $salesInfo['reference']; ?>
                                                    </td>
                                                    <td><?php echo number_format($salesInfo['grandTotal'], 2); ?></td>
                                                    <td>
                                                        <?php echo $salesInfo['paymentStatus']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $salesInfo['deliveryStatus']; ?>
                                                    </td>
                                                    <td><?php echo $utility->niceDateFormat($salesInfo['date']); ?></td>
                                                    <td>
                                                        <?php if ($salesInfo['payment_status'] == 0) {?>
                                                            <div class="d-flex">
                                                                <a href="generateInvoice?reference=<?php echo $salesInfo['reference']; ?>" class="btn btn-primary shadow btn-xs sharp mr-1" target="__blank"><i class='fa fa-print'></i></a>
                                                        ...
                                                        <?php } else if ($salesInfo['payment_status'] == 2 AND $salesInfo['delivery_status'] == 2  AND isset($salesInfo['checkoutStaff'])) { ?>
                                                            <small class="text-primary d-block"><?php echo $salesInfo['checkoutStaff'];?></small>
                                                            <small class="text-default d-block"><?php echo $salesInfo['checkoutDate'];?></small>
                                                        <?php } else if ($salesInfo['payment_status'] == 1 AND $salesInfo['delivery_status'] == 1 AND isset($salesInfo['checkoutStaff'])) { ?>
                                                            <small class="text-primary d-block"><?php echo $salesInfo['checkoutStaff'];?></small>
                                                            <small class="text-default d-block"><?php echo $salesInfo['checkoutDate'];?></small>
                                                        <?php } ?>
                                                    </td>
